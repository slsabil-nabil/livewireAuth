...
<head>
    ...
    @livewireStyles
    @stack('styles')
    @include('layouts.partials.common'){{-- تم نقل جميع التنسيقات والستايلات إلى هذا الملف --}}
</head>
...
<body class="bg-dashboard min-h-screen font-app">
    ...
    <main class="w-full px-4 py-6">
        <div
            class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-[rgba(var(--primary-500),0.2)] p-6">
            {{ $slot }}
        </div>
    </main>
