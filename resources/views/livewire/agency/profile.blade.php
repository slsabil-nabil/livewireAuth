<div class="space-y-6">
    <!-- عنوان الصفحة -->
    <x-page-title title="بيانات الوكالة">
        إدارة بيانات الوكالة وتحديث بيانات التواصل والموقع
    </x-page-title>
    ...
    <div class="bg-white rounded-xl shadow-md p-6">
        ...
        <!-- النموذج -->
        <form wire:submit.prevent="update" class="space-y-6 text-sm" enctype="multipart/form-data">
            @php
            ...
            @can('agency.profile.edit')
                <div class="flex justify-end mt-6 pb-2">
                    <button type="submit"
