    ...
    <div class="flex flex-col h-screen overflow-hidden">
        ...
        <div class="flex-none p-4 bg-gray-50">
            ...
            <div class="bg-white rounded-xl shadow-md p-4">
                <x-page-title title="إضافة وكالة جديدة" align="center">
                    تعيين بيانات الوكالة والأدمن المسؤول
                </x-page-title>
                @if ($successMessage)
                ...
                <form wire:submit.prevent="save" class="space-y-4 text-sm" id="mainForm">
                    ...
                    <div class="grid md:grid-cols-3 gap-3">
                        ...
                        <div class="{{ $containerClass }}">
                            <input type="text" wire:model.defer="main_branch_name" class="{{ $fieldClass }}"
                        ...
                        <div class="{{ $containerClass }}">
                            <input type="email" wire:model.defer="agency_email" class="{{ $fieldClass }}"
                                placeholder="البريد الإلكتروني للوكالة" />
                    ...
                    <div class="grid md:grid-cols-3 gap-3">
                        <div class="{{ $containerClass }}">
                            <input type="date" wire:model.defer="subscription_start_date"
                                class="{{ $fieldClass }}" placeholder="تاريخ بداية الاشتراك" />
                        ...
                        <div class="{{ $containerClass }}">
                            <input type="date" wire:model.defer="subscription_end_date"
                                class="{{ $fieldClass }}" placeholder="تاريخ نهاية الاشتراك" />
                    ...
                    <!-- ... الحقول الأخرى ... -->
                    <div class="{{ $containerClass }}">
                        <input type="number" wire:model.defer="max_users" class="{{ $fieldClass }}"
                            placeholder="الحد الأقصى للمستخدمين" min="1" max="100" />
                    ...
                    <div class="border-t border-gray-200 pt-6 mt-6">
                        <x-section-title title="بيانات أدمن الوكالة" align="center" />
                        <div class="grid md:grid-cols-3 gap-3">
                            <div class="{{ $containerClass }}">
                            ...
                            <div class="{{ $containerClass }}">
                                <input type="password" wire:model.defer="admin_password" class="{{ $fieldClass }}"
