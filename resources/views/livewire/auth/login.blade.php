        ...
        <div class="flex-none p-4">
            <div class="bg-white rounded-xl shadow-md p-8 max-w-md mx-auto">
                ...
                <div class="text-center mb-8">
                    ...
                    <x-page-title title="تسجيل الدخول">
                ...
                <form wire:submit.prevent="login" class="space-y-6">
                    ...
                    <div>
                        <label for="email" class="block text-sm font-medium text-gray-600 mb-2">البريد
                            الإلكتروني</label>
                        <div class="relative">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="text-sm">
                            <a href="/forgot-password"
                                class="font-medium text-primary-500 hover:text-primary-600 transition">نسيت كلمة
                                المرور؟</a>
                        </div>
                    </div>
